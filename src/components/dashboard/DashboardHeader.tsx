...
import { Plus, BarChart3, Home, ChevronDown, Users, Menu, Calendar } from "lucide-react";
...
const DashboardHeader = () => {
  ...
  console.log('DashboardHeader - Current path:', location.pathname, 'isDashboardPage:', isDashboardPage);
